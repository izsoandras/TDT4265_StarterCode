...
class BasicModel(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.layer_5 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(in_channels=output_channels[4], out_channels=256, kernel_size=3, stride=1, padding=1),
            nn.ReLU(),
            nn.BatchNorm2d(256),
            nn.Conv2d(in_channels=256, out_channels=output_channels[5], kernel_size=3, stride=1, padding=0),
            nn.Dropout2d(p=0.5),
            nn.ReLU(),
        )
